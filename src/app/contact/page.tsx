    ...
    <div className="min-h-screen bg-white text-[#1d1d1f] antialiased selection:bg-[#003366] selection:text-white">
      <div className="max-w-[1200px] mx-auto px-6 py-32 md:py-48">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-16 lg:gap-20">
          ...
          >
            <form className="space-y-10 md:space-y-12" onSubmit={handleWhatsAppSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 md:gap-y-12">
                <div className="group relative">
                  <label className="text-[10px] md:text-[11px] font-bold uppercase tracking-widest text-slate-400 group-focus-within:text-[#003366] transition-colors">Phone Number</label>
                  <input type="tel" name="number" placeholder="+44789933452" className="w-full bg-transparent border-b border-slate-200 py-4 text-base md:text-[17px] outline-none focus:border-[#003366] transition-all placeholder:text-slate-200" required /> 
                </div>
                <div className="group relative">
